...
class Level8: SKScene, SKPhysicsContactDelegate{
    ...
    override func didMove(to view: SKView) {
        ...
        circ_made1.position = CGPoint (x: -245, y: 300)
        ...
        circ_made2.position = CGPoint (x: 245, y: 300)
        ...
        circ_made3.position = CGPoint (x: -245, y: -300)
        ...
        circ_made4.position = CGPoint (x: 245, y: -300)
        ...
        square_made2.position = CGPoint (x: 0, y: -345)
        ...
        square_made2.physicsBody?.applyImpulse(CGVector(dx: 40, dy: 90))
        ...
        square_made4.physicsBody?.friction = 0
        square_made4.physicsBody?.mass = 0.5
        square_made4.physicsBody?.applyImpulse(CGVector(dx: -90, dy: 50))
