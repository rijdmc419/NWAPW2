...
class LevelSecret: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        circ_made1.position = CGPoint (x: -200, y: 300)
        ...
        circ_made2.position = CGPoint (x: 150, y: 300)
        ...
        circ_made3.position = CGPoint (x: 200, y: -400)
        ...
        circ_made4.position = CGPoint (x: -200, y: -450)
        ...
        square_made1.position = CGPoint (x: -100, y: 200)
        ...
        square_made2.position = CGPoint (x: 100, y: 200)
        ...
        square_made3 = SKSpriteNode(imageNamed: "angryface")
        square_made3.name = "square"
        square_made3.userData = [
            "isCircle" : false
        ];
        square_made3.size = CGSize (width: 100, height: 100)
        square_made3.position = CGPoint (x: 100, y: -350)
        ...
        square_made3.physicsBody?.friction = 1
        square_made3.physicsBody?.mass = 0.5
        square_made3.physicsBody?.applyImpulse(CGVector(dx: -90, dy: -90))
        ...
        square_made4 = SKSpriteNode(imageNamed: "angryface")
        square_made4.name = "square"
        square_made4.userData = [
            "isCircle" : false
        ];
        square_made4.size = CGSize (width: 100, height: 100)
        square_made4.position = CGPoint (x: -100, y: -350)
        ...
        square_made4.physicsBody?.isDynamic = true
        square_made4.physicsBody?.affectedByGravity = false
        square_made4.physicsBody?.allowsRotation = false
        square_made4.physicsBody?.linearDamping = 0.0
        square_made4.physicsBody?.angularDamping = 0.0
        square_made4.physicsBody?.restitution = 1.0
        square_made4.physicsBody?.friction = 1
        square_made4.physicsBody?.mass = 0.5
        square_made4.physicsBody?.applyImpulse(CGVector(dx: -90, dy: -90))
        square_made4.physicsBody?.categoryBitMask = goodCategory
        square_made4.physicsBody?.collisionBitMask = goodCategory
        square_made4.physicsBody?.contactTestBitMask = goodCategory
        
        
        arrayCircles = [circ1, circ2, circ3, circ4]
        arraySprites = [circ_made1, circ_made2, circ_made3, circ_made4, square_made1, square_made2, square_made3, square_made4]
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if let location = touch?.location(in: self) {
            ...
            if clickedNodes.first?.name == "restartButton"
            {
                ...
                let level2 = LevelSecret(fileNamed: "LevelSecret")
            ...
            for item in arraySprites
            {
                ...
                if item.userData?.value(forKey: "isCircle") as? Bool == false {
                    
                    if item.alpha == 0 {
                        
                        squaresdestroyed = squaresdestroyed+1
                        if squaresdestroyed >= 8 {
                            ...
                            if clickedNodes.first?.name == "restartLevelButton"
                            {
                                ...
                                let circlechange = LevelSecret(fileNamed: "LevelSecret")
                                circlechange?.scaleMode = .aspectFill
                                self.view?.presentScene(circlechange!, transition: SKTransition.fade(withDuration: 0.5))
                            }
